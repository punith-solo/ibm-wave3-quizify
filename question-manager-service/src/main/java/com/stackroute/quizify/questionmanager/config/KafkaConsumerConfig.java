...
//        configs.put(ConsumerConfig.GROUP_ID_CONFIG, "newConsumers");
...
//    {
//        ConcurrentKafkaListenerContainerFactory<String, Question> factory = new ConcurrentKafkaListenerContainerFactory<String, Question>();
